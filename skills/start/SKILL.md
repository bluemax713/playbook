---
name: start
description: Session kickoff. Checks for playbook updates, reads WORK_LOG.md and CLAUDE.md, and presents a briefing with status, issues, and suggested next steps. Use when starting a new work session.
---
