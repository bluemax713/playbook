---
name: quick
description: Quick mode for bug fixes, small changes, and one-off tasks. Skips the full session briefing, does the task, logs a brief WORK_LOG entry, and commits. Use for small, well-defined tasks that don't need ceremony.
---
