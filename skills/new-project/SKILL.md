---
name: new-project
description: Full project setup with a guided interview — clone or create a repo, wire local config (CLAUDE.md, WORK_LOG.md, MCP servers), and get ready for a first session. Use when starting work on a new project.
---
